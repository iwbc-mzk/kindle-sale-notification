...
import { getProductId, getProductTitle, getProductPrice, getProductPoint, getProductUrl, createAwsCredentialsFromEnv, getEnvVariables } from "./urils";
...
function App() {
    ...
    const register = async () => {
        ...
        if (!awsRegion || !awsAccessKeyId || !awsSecretAccessKey || !awsLambdaFunctionUrl) {
            alert("Can not find Aws region or access key id or secret access key or lambda functions url.")
        }
